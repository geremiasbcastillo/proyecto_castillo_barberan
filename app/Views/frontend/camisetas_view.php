<div class="banner">
    <?php echo '<img src="assets/img/banner_camisetas.jpg" alt="">';?>
</div>
...
<div class="row row-col-1 g-4 mt-5 cards">
  <div class="col">
    ...
    <?php echo '<img src="assets/img/galeria1.png" class="card-img-top" alt="...">';?>
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
    <?php echo '<img src="assets/img/galeria2.png" class="card-img-top" alt="...">';?>
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
    <?php echo '<img src="assets/img/camiseta-argentina-2.png" class="card-img-top" alt="...">';?>
      <div class="card-body">
